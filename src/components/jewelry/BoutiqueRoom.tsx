    ...
    >
      ...
      >
        ...
        {isMobile && (
          ...
          >
            {/* Left Shelf */}
            <div className="relative flex flex-col items-center justify-end" style={{ width: "32vw", height: "22vh", maxWidth: "160px" }}>
              ...
              <div className="pointer-events-auto flex flex-col items-center relative z-10 w-full h-[60%] pb-[2%]">
            ...
            {/* Center Shelf */}
            <div className="relative flex flex-col items-center justify-end" style={{ width: "36vw", height: "24vh", maxWidth: "180px" }}>
              <Image src="/shelf.png" alt="" aria-hidden fill className="absolute inset-0 w-full h-full z-0 pointer-events-none" style={{ objectFit: "fill" }} />
              <div className="pointer-events-auto flex flex-col items-center relative z-10 w-full h-[60%] pb-[2%]">
                <div style={{ width: "80%", height: "100%", zIndex: 20, "--product-size": "100%" } as any}>
