      ...
      >
        ...
        {isMobile && (
          <>
            ...
            >
              <div className="pointer-events-auto" style={{ position: "absolute", top: "75%", left: "50%", transform: "translate(-50%, -93%)" }}>
                <div style={{ position: "relative", zIndex: 20 }}>
                  {entered && <LineShelfProductMini config={getCustomProductConfig("pro1", 0, "left")} mountDelay={900} />}
                </div>
            ...
            >
              <div className="pointer-events-auto" style={{ position: "absolute", top: "75%", left: "50%", transform: "translate(-50%, -93%)" }}>
                <div style={{ position: "relative", zIndex: 20 }}>
                  {entered && <LineShelfProductMini config={getCustomProductConfig("pro3", 2, "right")} mountDelay={1700} />}
                </div>
                {/* Display Pedestal Box */}
                <div 
                  style={{
        ...
        >
          ...
          <div className="relative flex flex-col items-center justify-end" style={{ width: "clamp(120px, 20vw, 300px)", height: "clamp(80px, calc(38vh - 100px), 380px)" }}>
            ...
            <div className="pointer-events-auto flex flex-col items-center relative z-10 w-full h-[65%] pb-[10%]">
              <div style={{ width: "80%", height: "100%", zIndex: 20, "--product-size": "100%" } as any}>
                {entered && <LineShelfProductMini config={getCustomProductConfig("pro3", 0, "left")} mountDelay={900} />}
              </div>
            </div>
          </div>
          ...
          <div className="relative flex flex-col items-center justify-end" style={{ width: "clamp(120px, 20vw, 300px)", height: "clamp(80px, calc(38vh - 100px), 380px)" }}>
            ...
            <div className="pointer-events-auto flex flex-col items-center relative z-10 w-full h-[65%] pb-[10%]">
              <div style={{ width: "80%", height: "100%", zIndex: 20, "--product-size": "100%" } as any}>
                {entered && <LineShelfProductMini config={getCustomProductConfig("pro4", 1, "left")} mountDelay={500} />}
              </div>
            </div>
          </div>
          ...
          <div className="relative flex flex-col items-center justify-end" style={{ width: "clamp(120px, 20vw, 300px)", height: "clamp(80px, calc(38vh - 100px), 380px)" }}>
            ...
            <div className="pointer-events-auto flex flex-col items-center relative z-10 w-full h-[65%] pb-[10%]">
              <div style={{ width: "80%", height: "100%", zIndex: 20, "--product-size": "100%" } as any}>
                {entered && <LineShelfProductMini config={getCustomProductConfig("pro5", 2, "right")} mountDelay={1300} />}
              </div>
            </div>
          </div>
        </div>
